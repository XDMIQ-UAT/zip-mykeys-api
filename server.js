  ...
  for (const testPath of possiblePaths) {
    if (fs.existsSync(testPath)) {
      ...
      try {
        ...
        const hasDeploymentLog = fileContent.includes('CACHE BUST') || fileContent.includes('V2 FILE');
